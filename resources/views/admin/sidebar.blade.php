    ...
    <ul class="nav">
      ...
      <li class="nav-item menu-items">
        <a class="nav-link" data-toggle="collapse" href="#ui-basic" aria-expanded="false" aria-controls="ui-basic">
          ...
          <span class="menu-title">Product (Sản phẩm)</span>
        ...
        <div class="collapse" id="ui-basic">
          <ul class="nav flex-column sub-menu">
            ...
            <li class="nav-item"> 
              <a class="nav-link" href="{{ url('/show_product') }}">Hiển thị sản phẩm</a>
            </li>
          </ul>
        </div>
      </li>
      <li class="nav-item menu-items">
        <a class="nav-link" href="{{ url('view_category') }}">
          ...
          <span class="menu-title">Category (Danh Mục)</span>
        </a>
      </li>
      ...
      <li class="nav-item menu-items">
        <a class="nav-link" href="{{ url('Comment') }}">
          ...
          <span class="menu-title">Quản lý bình luận trang</span>
        </a>
      </li>
      <li class="nav-item menu-items">
        <a class="nav-link" href="{{ url('Comment_product') }}">
          <span class="menu-icon">
            <i class="mdi mdi-playlist-play"></i>
          </span>
          <span class="menu-title">Bình luận Sản phẩm</span>
        </a>
      </li>

<header class="header_section">
    <div class="container">
        <nav class="navbar navbar-expand-lg custom_nav-container ">
            <a class="navbar-brand" href="{{ url('/') }}"><img height="90px" src="/images/logo.png" alt="#" /></a>
    ...
    <div class="container mt-2">
        <form action="{{ url('product_search') }}" method="GET" class="form-inline justify-content-center">
            @csrf
            <div class="input-group style-search-bar" style="width: 100%; max-width: 600px;">
                <input style="text-transform: none !important;" type="text" name="search" class="form-control" placeholder="Bạn có thể tìm kiếm sản phẩm ở đây">
